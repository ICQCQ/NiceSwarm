...
const CLASSES := {
	...
	"interceptor": [  # projects/casts jamming fields that destroy player projectiles; always flees
		...
		# Disperser: drops a big lingering field on a random live enemy.
		{"name": "Disperser", "hp0": 28.0, "hpk": 6.0, "spd": 78.0, "spdk": 1.0, "r": 17.0, "dmg": 2, "xp": 11, "col": Color(0.8, 0.25, 0.35), "shape": "hex", "pull_imm": true, "move": 4, "icast_pattern": 2, "icast_radius": 190.0, "icast_life": 6.0, "icast_count": 1, "icast_cooldown": 8.0},
		# Overseer: rare — casts a single very long line of fields across the arena at a random angle.
		{"name": "Overseer", "hp0": 42.0, "hpk": 8.0, "spd": 80.0, "spdk": 1.0, "r": 19.0, "dmg": 2, "xp": 16, "col": Color(0.9, 0.3, 0.4), "shape": "hex", "pull_imm": true, "move": 4, "icast_pattern": 3, "icast_radius": 110.0, "icast_life": 6.0, "icast_cooldown": 15.0},
	],
	...
	"boss": [
		...
		{"name": "Eclipse", "hp0": 1100.0, "hpk": 90.0, "spd": 50.0, "spdk": 0.0, "r": 38.0, "dmg": 5, "xp": 100, "col": Color(0.1, 0.04, 0.16), "shape": "circle", "elite": true, "pull_imm": true, "boss": true, "enrage_resist": 0.5, "summon_cls": "wisp", "summon_tier": 1, "summon_count": 4, "summon_cooldown": 8.0, "slam_pattern": 5, "slam_radius": 55.0, "slam_damage": 4, "slam_cooldown": 5.5},
	],
}
